...
export default function Scanner() {
    ...
    useEffect(() => {
        ...
        const loop = setInterval(async () => {
            if (view !== 'face' || isProcessing || loading || processingRef.current) return;
    ...
    const captureAndVerify = async () => {
        if (!videoRef.current || !canvasRef.current || view !== 'face' || isProcessing || processingRef.current) return;
            ...
            try {
                if (NativeBiometric) {
                    ...
                    if (avail.isAvailable) {
                        const authParams = {
                            reason: 'Authenticate to view details',
                        ...
                        <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-[400px] md:h-[400px]">
                            ...
                            <div className="w-full h-full rounded-[2rem] md:rounded-[2.5rem] overflow-hidden bg-black border-2 border-white/5 shadow-2xl relative">
                                ...
                                <motion.div
                                    ...
                                    className="absolute left-0 right-0 h-[1.5px] bg-gradient-to-r from-transparent via-blue-400 to-transparent z-10 opacity-70"
                                />
                            </div>
                        </div>
                ...
                {view === 'checkin' && (
                    <motion.div key="checkin"
                        ...
                        <div className="space-y-4 px-4">
                            ...
                            <p className="text-emerald-400/80 font-bold text-sm md:text-xl mt-2 italic">Thank you for checking in!</p>
                ...
                {view === 'checkout' && (
                    <motion.div key="checkout"
                        ...
                        <div className="space-y-4 px-4">
                            ...
                            <p className="text-indigo-400/80 font-bold text-sm md:text-xl mt-2 italic">Thank you! Have a great day.</p>
                            <div className="flex flex-col items-center gap-2 pt-2">
