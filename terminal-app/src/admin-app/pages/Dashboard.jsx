...
export default function Dashboard() {
    ...
    const kpis = [
        ...
        },
        {
            ...
            state: { status: 'ON_TIME' } // Or empty for all scans
        },
        {
            label: 'Absent Today',
        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 text-[10px] md:text-sm font-medium uppercase tracking-[0.2em]">Operational Oversight // EngLabs Attendance Tracker v2.4</p>
                </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
                {kpis.map((kpi, i) => (
                    <div key={i}
                        ...
                        className={`cursor-pointer relative overflow-hidden rounded-2xl bg-gradient-to-br ${kpi.gradient} border ${kpi.border} p-4 sm:p-6
                ...
                {/* --- Door Status Card --- */}
                <div onClick={() => navigate('/admin/door-control')} className={`cursor-pointer relative overflow-hidden rounded-2xl bg-white border-slate-200 p-4 sm:p-6 
                                hover:scale-[1.02] hover:shadow-lg transition-all duration-300 group`}>
                    ...
                    <button
                        onClick={(e) => { e.stopPropagation(); handleRemoteUnlock(); }}
