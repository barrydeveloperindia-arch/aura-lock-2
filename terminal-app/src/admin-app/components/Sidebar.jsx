        ...
        <aside className={`fixed left-0 top-0 bottom-0 w-[260px] bg-white border-r border-slate-200 flex flex-col z-50 transition-transform duration-300 md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'} shadow-[4px_0_24px_rgba(0,0,0,0.02)]`}>
            ...
            <div className="p-6 mb-2 flex items-center justify-between md:justify-start">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#52b39a] to-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-500/20 text-white font-black text-lg">
                    ...
                    <div className="flex flex-col">
                        <h1 className="font-black text-[#24546e] tracking-tight text-lg leading-none">
                            Eng<span className="text-[#52b39a] font-normal">labs</span>
                        </h1>
                        <span className="text-[7px] font-black text-slate-400 tracking-wider mt-0.5">ATTENDANCE TRACKER (EAT)</span>
                    </div>
                </div>
                <button 
                    onClick={onClose} 
