        ...
        <div className="flex w-full max-w-full h-screen bg-[#f8fafc] text-slate-800 font-sans overflow-hidden">
            ...
            <header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white/90 backdrop-blur-lg border-b border-slate-200 flex items-center justify-between px-6 z-40 shadow-sm">
                <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#52b39a] to-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-600/20">
                        <svg className="w-5 h-5 text-white" viewBox="0 0 100 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className="font-bold text-[#24546e] text-sm tracking-tight">Eng<span className="text-[#52b39a] font-normal">labs</span> <span className="text-slate-400 font-bold ml-1">Attendance Tracker (EAT)</span></h1>
                </div>
                <button 
